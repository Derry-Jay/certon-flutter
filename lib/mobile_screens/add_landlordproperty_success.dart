...
class AddPropertyLandlordSuccess extends StatefulWidget {
  final RouteArgument rar;
  const AddPropertyLandlordSuccess({Key? key, required this.rar})
      : super(key: key);

  @override
  AddPropertyLandlordSuccessState createState() =>
      AddPropertyLandlordSuccessState();
}

class AddPropertyLandlordSuccessState
    extends StateMVC<AddPropertyLandlordSuccess> {
